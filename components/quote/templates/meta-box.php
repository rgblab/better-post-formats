...
<div class="upf-control upf-control--quote">
    <div class="upf-control__textarea">
        ...
        <textarea class="upf-control__textarea-field" name="<?php echo esc_attr( $input_field_attr ); ?>[0]" rows="4" value="<?php echo esc_attr( get_post_meta( $post->ID, $meta_key, true )[0] ); ?>"></textarea>
    </div>
