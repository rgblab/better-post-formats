...
<div class="upf-control upf-control--audio">
    <div class="upf-control__text">
        ...
        <input class="upf-control__input" type="text" name="<?php echo esc_attr( $input_field_attr ); ?>[0]" value="<?php echo esc_attr( get_post_meta( $post->ID, $meta_key, true )[0] ); ?>">
    </div>
    <div class="upf-control__select">
        ...
        <select class="upf-control__options" name="<?php echo esc_attr( $input_field_attr . '[1]' ); ?>">
