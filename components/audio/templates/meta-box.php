...
$input_field_attr      = betterPostFormatsHelper::swapUnderscoreDash( $meta_key ); // bpf-audio
...
<div class="bpf-control bpf-control--audio">
	<div class="bpf-control__text">
		<label class="bpf-control__label" for="<?php echo esc_attr( $input_field_attr . '[0]' ); ?>"><?php esc_html_e( 'Enter URL pointing to audio file or audio streaming provider', 'bpf' ); ?></label>
